...
import (
	...
	"github.com/LFroesch/tui-hub/suitechrome"
...
func (m model) renderStatus() string {
	...
	if m.demo {
		return dimStyle.Render("  Public demo: sandboxed session, fresh workspace every run, limited integrations. Every app here also can be downloaded or run by itself.")
	}
	return ""
}
